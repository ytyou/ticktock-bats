...
check_status "$?"
echo "RESP1=$RESP"
check_output4 "$RESP" '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}}]'
...
check_status "$?"
echo "RESP3=$RESP"
check_output4 "$RESP" '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}}]'  '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}}]'

RESP=`query_tt_get "start=1d-ago&m=sum:explicit_tags:filters.metric%7Bhost=*%7D%7Bdc=*%7D"`
check_status "$?"
echo "RESP4=$RESP"
check_output4 "$RESP" '[{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":["dc"],"dps":{"'$TS'":11.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}},{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":["dc"],"dps":{"'$TS'":11.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'  '[{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":["dc"],"dps":{"'$TS'":11.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]'  '[{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":["dc"],"dps":{"'$TS'":11.0}}]'

RESP=`query_tt_get "start=1d-ago&m=sum:explicit_tags:filters.metric%7Bhost=*,dc=*%7D"`
check_status "$?"
echo "RESP5=$RESP"
check_output_contains '{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}}' "$RESP"
check_output_contains '{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}}' "$RESP"
check_output_contains '{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}' "$RESP"
check_output_contains '{"metric":"filters.metric","tags":{"dc":"lax","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":8.0}}' "$RESP"
check_output_contains '{"metric":"filters.metric","tags":{"dc":"lax","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":4.0}}' "$RESP"
