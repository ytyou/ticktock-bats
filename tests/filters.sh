...
check_status "$?"
echo "RESP1=$RESP"
check_output "$RESP" '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web01"},"aggregateTags":[],"dps":{"'$TS'":3.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web02"},"aggregateTags":[],"dps":{"'$TS'":2.0}},{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]'
...
check_status "$?"
echo "RESP4=$RESP"
check_output "$RESP" '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":["dc"],"dps":{"'$TS'":11.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]'
...
check_status "$?"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bhost=not_iliteral_or(Web01)%7D"`
check_status "$?"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bhost=not_literal_or(web01|web02)%7D"`
check_status "$?"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bhost=not_iliteral_or(Web01|WEB02)%7D"`
check_status "$?"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bowner=not_literal_or(jdoe)%7D"`
check_status "$?"
check_output '[]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bhost=literal_or(web01|web02|web03)%7D"`
check_status "$?"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":[],"dps":{"'$TS'":16.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=sum:filters.metric%7Bhost=iliteral_or(Web01|WEB02|web03)%7D"`
check_status "$?"
echo "RESP=$RESP"
check_output '[{"metric":"filters.metric","tags":{"dc":"dal","host":"web03"},"aggregateTags":[],"dps":{"'$TS'":10.0}},{"metric":"filters.metric","tags":{"host":"web01"},"aggregateTags":[],"dps":{"'$TS'":16.0}},{"metric":"filters.metric","tags":{"host":"web02"},"aggregateTags":["dc"],"dps":{"'$TS'":6.0}}]' "$RESP"
