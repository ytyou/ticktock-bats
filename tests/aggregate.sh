...
RESP=`query_tt_get "start=1d-ago&m=none:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{"t1":"v1"},"aggregateTags":[],"dps":{"'$TS1'":1.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=top1:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{"t1":"v1"},"aggregateTags":[],"dps":{"'$TS1'":1.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=top10:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{"t1":"v1"},"aggregateTags":[],"dps":{"'$TS1'":1.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=bottom1:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{"t1":"v1"},"aggregateTags":[],"dps":{"'$TS1'":1.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=bottom10:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{"t1":"v1"},"aggregateTags":[],"dps":{"'$TS1'":1.0}}]' "$RESP"
...
RESP=`query_tt_get "start=1d-ago&m=top2:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{},"aggregateTags":["t1"],"dps":{"'$TS1'":1.0,"'$TS1'":2.0}}]' "$RESP"
...
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{},"aggregateTags":["t1"],"dps":{"'$TS1'":2.0,"'$TS1'":1.0}}]' "$RESP"
...
RESP=`query_tt_get "start=1d-ago&m=top2:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{},"aggregateTags":["t1"],"dps":{"'$TS1'":2.0,"'$TS1'":3.0}}]' "$RESP"

RESP=`query_tt_get "start=1d-ago&m=top3:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{},"aggregateTags":["t1"],"dps":{"'$TS1'":1.0,"'$TS1'":2.0,"'$TS1'":3.0}}]' "$RESP"
...
RESP=`query_tt_get "start=1d-ago&m=bottom3:aggregate.metric"`
check_status "$?"
check_output '[{"metric":"aggregate.metric","tags":{},"aggregateTags":["t1"],"dps":{"'$TS1'":3.0,"'$TS1'":2.0,"'$TS1'":1.0}}]' "$RESP"
