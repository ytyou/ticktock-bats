...
check_status "$?"
echo "RESP=$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":100.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":200.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":300.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":400.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":500.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":600.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":700.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":800.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":900.0}}' "$RESP"
...
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":200.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":300.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":400.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":500.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":600.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":700.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":800.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":900.0}}' "$RESP"

RESP=`query_tt_post '{"start":"1d-ago","queries":[{"aggregator":"none","metric":"tags.metric2","tags":{"tag1":"val2"}}]}'`
check_status "$?"
echo "RESP=$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":100.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":200.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val1","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":300.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":400.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val2"},"aggregateTags":[],"dps":{"'$TS'":500.0}}' "$RESP"
check_output_contains '{"metric":"tags.metric2","tags":{"tag1":"val2","tag2":"val3"},"aggregateTags":[],"dps":{"'$TS'":600.0}}' "$RESP"
check_output_not_contains '{"metric":"tags.metric2","tags":{"tag1":"val3","tag2":"val1"},"aggregateTags":[],"dps":{"'$TS'":700.0}}' "$RESP"
